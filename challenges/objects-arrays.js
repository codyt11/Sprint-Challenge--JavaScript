...
function studentInfo(graduates){
const contactInfo = [];
for (let i = 0; i < graduates.length; i++){
...
console.log(studentInfo(graduates));
...
*/
function lowerPop(zooAnimals, population) {
  return zooAnimals.filter(animal => animal.population < 5);
}


console.log(lowerPop(population));
/* Request 4: .reduce() 
